          ...
          {paginatedPlayedGames.length > 0 ? (
            ...
            <Card>
              <CardContent className="p-8 sm:p-12 text-center text-muted-foreground">
                <p className="text-sm sm:text-base">No played games found on this page</p>
              </CardContent>
            </Card>
          ) : (
            <Card>
              <CardContent className="p-8 sm:p-12 text-center text-muted-foreground space-y-3 sm:space-y-4">
                <p className="text-base sm:text-lg font-semibold">No games played yet</p>
                <p className="text-xs sm:text-sm">Mark games as played to see them here</p>
              </CardContent>
            </Card>
          )}
        </div>
