            ...
            <CardContent className="space-y-4">
              {stat.usage.perSecond && stat.usage.perSecond.limit && (
                <div className="space-y-2">
                  ...
                  <Progress value={stat.usage.perSecond.count} max={stat.usage.perSecond.limit} />
                </div>
              )}
              ...
              {stat.usage.perMinute && stat.usage.perMinute.limit && (
                <div className="space-y-2">
                  ...
                  <Progress value={stat.usage.perMinute.count} max={stat.usage.perMinute.limit} />
                </div>
              )}
              ...
              {stat.usage.perHour && stat.usage.perHour.limit && (
                <div className="space-y-2">
                  ...
                  <Progress value={stat.usage.perHour.count} max={stat.usage.perHour.limit} />
                </div>
              )}
              ...
              {stat.usage.perDay && stat.usage.perDay.limit && (
                <div className="space-y-2">
                  ...
                  <Progress value={stat.usage.perDay.count} max={stat.usage.perDay.limit} />
                </div>
              )}
              ...
              {stat.usage.perMonth && stat.usage.perMonth.limit && (
                <div className="space-y-2">
                  ...
                  <Progress value={stat.usage.perMonth.count} max={stat.usage.perMonth.limit} />
                </div>
              )}
