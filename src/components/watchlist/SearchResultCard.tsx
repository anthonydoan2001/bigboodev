      ...
      <div className="group relative space-y-2" style={{ width: 'var(--item-width, 100%)', maxWidth: 'var(--item-width, 100%)' }}>
        ...
        >
          ...
          {alreadyInList && !isWatched && !isWatching && (
            <div className="absolute left-1.5 top-1.5 flex items-center gap-0.5 rounded-md bg-emerald-500/90 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white backdrop-blur-md shadow-sm z-10">
          ...
          {isWatching && (
            <div className="absolute left-1.5 top-1.5 flex items-center gap-0.5 rounded-md bg-blue-500/90 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white backdrop-blur-md shadow-sm z-10">
        ...
        <div className="space-y-1">
          <h3 className="line-clamp-2 text-sm font-semibold leading-tight text-foreground/90 min-h-[2.2rem]" title={result.title}>
            {result.title}
          </h3>
